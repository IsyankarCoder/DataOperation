...
aykiridegerler = boxplot_stats(verisetim.horsepower).pop(0)["fliers"]
aykiridegerIndeksleri = verisetim.index[verisetim.horsepower.isin(aykiridegerler)==True]
verisetim=verisetim.drop(aykiridegerIndeksleri,axis=0)


print(aykiridegerler)
print("--------------------------------")
print(aykiridegerIndeksleri)
