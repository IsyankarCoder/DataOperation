...
random.seed(123)
# 1. örneklem: sonucu sakla ve yazdır
sampled1 = sample(listem, 10)  # Kod 1. kez çalıştırılıyor
print("Sample 1 (list):", sampled1)
print("Sample 1 (line):")
for x in sampled1:
	print(x)
...
random.seed(123)
# 2. örneklem: yeni örneği sakla ve yazdır
sampled2 = sample(listem, 10)  # Kod 2. kez çalıştırılıyor
print("Sample 2 (list):", sampled2)
print("Sample 2 (line):")
for c in sampled2:
	print(c)
