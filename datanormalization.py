...
print(n_veriseti.describe())
print("--------------------------------")


veri2 = verisetim.iloc[:,0:8]
stScaler = StandardScaler()
s_veriseti =stScaler.fit_transform(veri2)
s_veriseti = pd.DataFrame(s_veriseti,columns=veri2.columns)

print(s_veriseti.describe())
